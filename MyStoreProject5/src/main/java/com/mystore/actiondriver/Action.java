...
public class Action extends BaseClass implements ActionInterface {
	...
	public String screenShot(WebDriver driver, String filename) {
		...
		String newImageString = "http://localhost:8080/job/MyStoreProject/ws/MyStoreProject5/Screenshots/" + filename + "_"
				+ dateName + ".png";
	...
	@Override
	public boolean isDisplayed2(WebDriver ldriver, By ele) {
		// TODO Auto-generated method stub
		boolean flag = false;
		flag = findElement2(ldriver, ele);
			if (flag) {
				System.out.println("The element is Displayed");
			} else {
				System.out.println("The element is not Displayed");
	...
	@Override
	public boolean findElement2(WebDriver ldriver, By ele) {
		// TODO Auto-generated method stub
		boolean flag = false;
		try {
			flag = ldriver.findElement(ele).isDisplayed();
		} catch (Exception e) {
			flag = false;
		} finally {
			if (flag) {
	...
	@Override
	public void click2(WebDriver ldriver, By ele) {
		// TODO Auto-generated method stub
		boolean flag = false;
		try
		{
	...
	@Override
	public boolean type2(By ele, String text) {
		// TODO Auto-generated method stub
		boolean flag = false;
		try {
